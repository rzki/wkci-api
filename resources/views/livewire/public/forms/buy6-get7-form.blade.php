<div>
    <div class="container">
        <div class="row">
            <div class="card">
                <h2 class="fw-extrabold text-center py-3">Seminar Registration ( Buy 6 Get 7 ) <br> Jakarta Dental Exhibition (JADE) 2024
                </h2>
                <div class="card-body">
...
{{--                            <div class="form-group mb-4 hands-on-dropdown">--}}
